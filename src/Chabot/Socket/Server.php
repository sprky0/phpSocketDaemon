...
class Server extends Socket {
	...
	{
        $socket = parent::accept();
		$client = new $this->client_class($socket, $this);

		if (!$client instanceof ServerClient) {
			throw new Exception("Invalid serverClient class specified! Has to be a subclass of ServerClient");
		}
