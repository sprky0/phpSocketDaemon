 ...
 */
abstract class ServerClient extends SocketClient {
	public $socket;
	...
	public function __construct($socket, $server = null)
	{
		...
		if (!is_resource($this->socket)) {
			...
			throw new Exception("Could not retrieve remote address & port: ".socket_strerror(socket_last_error($this->socket)));
		}
